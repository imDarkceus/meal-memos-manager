...
const MealTracking = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sticky top-0 z-50 bg-background pb-4 pt-2 border-b shadow-md flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
